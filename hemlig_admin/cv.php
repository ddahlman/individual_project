      ...
      <div class="white-bg">
        <form action="">
          ...
          <div>
            ...
            <div class='alert alert-success cv-text'><strong>Din text är sparad!</strong></div>
          </div>
        </form>
      </div>
    </div>
        ...
        <form class='header-form' action="">
          <div class='form-group row'>
            <div class='col-md-6'>
              ...
              <input type="text" class='form-control header' name="first-header">
            </div>
          </div>
          <div class='form-group'>
            <input type="hidden" value="1">
            <input type="button" class='btn btn-info grey-headers' name="save-1st-header" value="spara rubrik">
          </div>
        </form>
        <div class='alert alert-success cv-header-1'><strong>Din rubrik är sparad!</strong></div>
        <hr>
...
?>
    ...
    <div class="row">
      <div class="white-bg">
        ...
        <div class='alert alert-success cv-header-2'><strong>Din rubrik är sparad!</strong></div>
        <hr>
...
?>
    ...
    <div class="row">
      <div class="white-bg">
        ...
        <div class='alert alert-success cv-header-3'><strong>Din rubrik är sparad!</strong></div>
        <hr>
