...
<div class="flex-row">
  <div class="flex-col">
    <p>
      Jag studerar på den framgångsrika utbildningen Front End Developer på KYH i Stockholm som specialiserar sig inom webbutveckling och webbsidor och hur man kan få dom så användarvänliga och snabbladdade som möjligt. Förutom de grundläggande programmeringsspråken
      som HTML, CSS och Javascript så vidareutvecklar vi oss i PHP och andra tekniker för att kunna utföra en webbuplevelse som passar alla behov.
    </p>
  </div>
</div>
...
<div class="flex-col-card project expand">
  ...
  <div class="myInfo">
    <p>
      ...
      skulle en modal visas med en carousel som hade fler placeholders, ungefär som en vanlig webbshop. Sedan skapade jag en "shopping cart"-knapp som öppnade ännu en modal där användaren kunde se sina tillagda varor och därefter kunde klicka på en knapp
      och gå vidare till ett utcheckningsformulär (fortfarande i modal-fönstret).
    </p>
    <div class="flex-footer grey-pants">
      <h1>tekniker</h1>
      <ul>
